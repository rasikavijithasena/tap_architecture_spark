...
public class StreamGroupFunction {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        SparkConf conf = new SparkConf().setAppName("com.spark.streaming.StreamGroupFunction").setMaster("local[*]");
        ...
        SparkSession spark = SparkSession
                .builder()
                .appName("Java Spark com.spark.streaming.StreamGroupFunction")
